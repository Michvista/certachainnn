  ...
  <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm flex items-center gap-6">
    ...
    <div className="space-y-2 flex-1">
      <div className="flex items-center gap-3">
        <h2 className="text-xl font-bold text-slate-800">Verified student</h2>
      ...
      <p className="text-xs text-slate-500 font-medium">Live profile metadata will appear here once a wallet or certificate lookup succeeds.</p>
      <div className="flex gap-8 pt-2">
        <div>
          <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Certificates</p>
          <p className="text-sm font-bold text-slate-700">Loaded from API</p>
        </div>
        <div className="border-l border-slate-100 pl-8">
          <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Verification</p>
          <p className="text-sm font-bold text-purple-600">Live</p>
        </div>
      </div>
    </div>
  </div>
